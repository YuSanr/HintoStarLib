 ...
 */
class LoveXZParticleStyle(var size:Double, var playTimes:Int, var particleGroup: HiaXnParticleGroup, var all:Boolean, var order:Boolean): HiaXnParticleStyle(){
    var index = 0
    var nowTimes = 0
    init {
        setIntervalTime(1)
    ...
    override fun getParticleList(location: Location): LinkedList<HiaXnParticleGroup> {
        val locList = ParticleMathUtil.getXZLoveLocation(location,size,size.toInt()*60)
